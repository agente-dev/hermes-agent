...
For the full design — comparisons with other agent boards, eight collaboration patterns, four user stories, and a concurrency correctness proof — see `docs/hermes-kanban-v1-spec.pdf` in the repository or the [Kanban user guide](/user-guide/features/kanban).
